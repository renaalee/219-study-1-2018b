...
BF for RATN 3-way interaction of grammar condition, hemisphere, and electrode site
```{r}
bf.anova.RATN <- lmBF(mean.amplitude ~ electrode.site * grammar.condition * hemisphere + subject, data=data.frame(eeg_data_RATN), whichRandom = "subject")
